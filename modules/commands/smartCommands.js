...
function handleContact(api, threadID, messageID) {
    const contactContent = `𝗔𝗱𝗺𝗶𝗻:
   Marjhxn
   📧 senseikshb@gmail.com@gmail.com
...
async function handleAria(api, event, body, threadID, messageID) {
    ...
    if (!prompt) {
        return api.sendMessage("What would you like to ask Gab?", threadID, messageID);
    }
...
async function handleInstagram(api, event, body, threadID, messageID) {
    ...
    api.sendMessage("Please wait...", threadID, async (err, info) => {
        ...
        try {
            ...
            const messageBody = `【 𝗚𝗔𝗕 】𝗜𝗚 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗿 📱
──────────────────
...
──────────────────`;
            ...
            const errorMessage = `【 𝗚𝗔𝗕 】𝗜𝗚 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗿 📱
──────────────────
❌ 𝗘𝗿𝗿𝗼𝗿: ${error.message}
